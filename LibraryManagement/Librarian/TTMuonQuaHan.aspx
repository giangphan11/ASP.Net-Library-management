<%@ Page Title="" Language="C#" MasterPageFile="~/Librarian/SiteLibra.Master" AutoEventWireup="true" CodeBehind="TTMuonQuaHan.aspx.cs" Inherits="LibraryManagement.Librarian.TTMuonQuaHan" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="noi_dung2" runat="server">
    ...
    <div style="margin: 0 auto" class="col-10 col-m-10 col-sm-10">
        <div class="card">
            <div class="card-header">
                <h3>Thống kê tài liệu mượn quá hạn
                </h3>
            </div>
    ...
    <asp:Button CssClass="button g" ID="btnXuatFilePdf" Text="Xuất file Pdf" runat="server" OnClick="btnExportWord_Click" />
    <asp:Button CssClass="button g" ID="btnXuatExcel" Text="Xuất file Excel" runat="server" OnClick="btnExportPDF_Click" />
