...
<asp:Content ID="Content3" ContentPlaceHolderID="noi_dung" runat="server">
    ...
    Bắt đầu: <asp:TextBox ID="txtDate1" CssClass="inp" Width="30%" TextMode="Date" runat="server" OnTextChanged="txtDate1_TextChanged" />
    ...
    <asp:Button ID="btnInPdf" CssClass="button g" runat="server" Text ="Xuất file pdf" />
    <asp:Button ID="btnInWord" runat="server" CssClass="button g" Text ="Xuất file Word" />
