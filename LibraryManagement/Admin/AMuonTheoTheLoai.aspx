...
<asp:Content ID="Content3" ContentPlaceHolderID="noi_dung" runat="server">
    ...
    <div style="margin: 0 auto;" class="col-9 col-m-9 col-sm-9">
        <div class="card">
            ...
            Bắt đầu:
            <asp:TextBox CssClass="inp" Width="30%" ID="txtDate1" TextMode="Date" runat="server" OnTextChanged="txtDate1_TextChanged" />
    ...
    <asp:Button Style="margin-right: 10px;" ID="btnInPdf" CssClass="button g" runat="server" Text="Xuất file Pdf" OnClick="btnInPdf_Click" />
    <asp:Button ID="btnInWord" CssClass="button g" runat="server" Text="Xuất file Excel" OnClick="btnInWord_Click" />
