        ...
        <div class="card">
            ...
            <table class="col-8 col-m-8 col-sm-8">
                <tr>
                    <td>Mã độc giả:</td>
                    <td>
                        <asp:TextBox CssClass="inp" Enabled="false" ID="txtMaDG" runat="server" /></td>
                </tr>
                <tr>
                    <td>Tên độc giả:</td>
                    <td>
                ...
                <tr>
                    ...
                    <td>Ngày sinh:</td>
                    <td>
                        <asp:TextBox CssClass="inp" ID="txtNgaySinh" runat="server" />
                ...
                <tr>
                    <td>Đối tượng: </td>
                    <td>
                        <asp:DropDownList CssClass="drop" ID="dropDownDoiTuong" runat="server" /></td>
                </tr>
                <tr>
                    <td>Ngày cấp:</td>
                    <td>
                        <asp:TextBox CssClass="inp" ID="txtNgayCap" runat="server" />
                        <ajaxToolkit:CalendarExtender
                ...
                <tr>
                    <td>Ngày hết hạn: </td>
                    <td>
                        <asp:TextBox CssClass="inp" ID="txtNgayHetHan" runat="server" />
                        <ajaxToolkit:CalendarExtender
                ...
                <tr>
                    <td>Ảnh: </td>
                    <td>
                        <asp:FileUpload CssClass="inp" runat="server" ID="fileAnhUpload" /></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:Button CausesValidation="true" CssClass="button" Width="100%" ID="btnSua" runat="server" Text="Sửa" OnClick="btnSua_Click" />
                    </td>
                </tr>
            </table>
